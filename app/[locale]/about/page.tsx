...
export default async function AboutPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <section style={{ position: "relative", background: "var(--blue)", backgroundImage: "url('/about-hero.jpg')", backgroundSize: "cover", backgroundPosition: "center", color: "white", paddingTop: "80px", paddingBottom: "64px" }} className="px-5 md:px-14">
