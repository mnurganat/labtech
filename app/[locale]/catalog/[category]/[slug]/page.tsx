    ...
    <>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "calc(100vh - 120px)" }} className="product-layout">
        ...
        <div style={{ padding: "56px", overflowY: "auto" }} className="px-5 md:px-14">
          ...
          <h1 style={{ fontFamily: "var(--font-playfair, 'Playfair Display', serif)", fontSize: "clamp(28px, 3vw, 42px)", fontWeight: 700, color: "var(--ink)", lineHeight: 1.15, marginBottom: 20, letterSpacing: "-0.01em" }}>
            {productName}
          </h1>
          {product.description && (
          ...
          <div style={{ background: "var(--silver)", padding: "24px 28px", marginBottom: 32, borderLeft: "3px solid var(--blue)" }}>
            ...
            <div style={{ fontFamily: "var(--font-playfair, 'Playfair Display', serif)", fontSize: 26, fontWeight: 700, color: "var(--ink)" }}>
          ...
          {product.features?.length > 0 && (
            <div style={{ marginTop: 48, paddingTop: 48, borderTop: "1px solid var(--border)" }}>
              <h2 style={{ fontFamily: "var(--font-playfair, 'Playfair Display', serif)", fontSize: 22, fontWeight: 700, color: "var(--ink)", marginBottom: 24 }}>
      ...
      {relatedProducts.length > 0 && (
        <section style={{ padding: "80px 56px", background: "var(--silver)", borderTop: "1px solid var(--border)" }} className="px-5 md:px-14">
          <div style={{ maxWidth: 1400, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-playfair, 'Playfair Display', serif)", fontSize: 28, fontWeight: 700, color: "var(--ink)", marginBottom: 40 }}>
